<header class="sticky top-0 z-[100]" x-data="{ mobileMenuOpen: false }">
    <nav class="bg-white shadow-sm border-b border-gray-100 relative z-[101]">
            ...
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="flex items-center md:hidden">
                    <button type="button" 
                            ...
                            class="text-gray-500 hover:text-[#013886] focus:outline-none p-2 rounded-md hover:bg-gray-50 transition-colors relative z-[102]" 
    ...
    <div class="md:hidden" 
        ...
        <div class="fixed inset-0 z-[999] bg-gray-900/50 backdrop-blur-sm transition-opacity" 
                x-show="mobileMenuOpen"
        ...
        <!-- Painel Lateral -->
        <div class="fixed inset-y-0 right-0 z-[1000] w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 transform transition-transform"
                x-show="mobileMenuOpen"
